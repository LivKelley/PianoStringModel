...
% parameters
k = 2.999991;         % spring constant (currently totally arbitrary)
x = 2.99999;          % x distance between masses, spring rest length
m = 35;          % mass of masses, totally arbitrary
