...
function piano_step_absolute_one_and_a_half()
...
b = .01;
time_end = 100;
k = 2;                 % completely arbitrary k value of springs
...
[T,Y] = ode45(@vibration, [0, time_end], Y_stuff);
...
%% now we get to make a function for the ode
    ...
    function derivs = vibration(T, Y_stuff)
        ...
        ay = -k * (sqrt(x^2 + y^2) - x) * y / sqrt(x^2 + y^2) - b * vy; %Velocity equation (described by sheet) 
